import typing
from typing import Generic, Literal, Optional, TypeVar, Union, Callable, final, Any, TypeAlias, NoReturn, TypeGuard
...
class Nothing(OptionBase[Any]): # Generic type doesn't matter for Nothing
    ...
    def unwrap(self) -> NoReturn: # Type hint refinement
